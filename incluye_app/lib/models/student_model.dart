...
class Student {
  ...
  final String
  email; // Email del estudiante, puede o no ser el mismo que User.email
  ...
  factory Student.fromJson(Map<String, dynamic> json) {
    return Student(
      ...
      email: json['email'] ?? '',
      userId:
          json['userId'] != null && json['userId'] is Map
              ? User.fromJson(json['userId'] as Map<String, dynamic>)
              : null,
      carreraId:
          json['carreraId'] != null && json['carreraId'] is Map
      ...
      necesidadesEducativasEspeciales:
          json['necesidadesEducativasEspeciales'] as String?,

      // hasDisability: json['hasDisability'] as bool? ?? false, // Eliminado
      telefono: json['telefono'] as String?,
      anioIngreso: json['anioIngreso'] as int?,
      consentimientoFirmado:
          json['consentimientoFirmado'] as bool? ??
          json['extras']?['consentimientoFirmado'] as bool? ??
          false, // Intenta leer de extras si existe para compatibilidad temporal
      diagnosticosAntiguos:
          json['diagnosticos'] != null && json['diagnosticos'] is List
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (necesidadesEducativasEspeciales != null)
