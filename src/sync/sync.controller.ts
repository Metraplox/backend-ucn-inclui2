...
export class SyncController {
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene la lista actualizada de estudiantes con Necesidades Educativas Especiales desde el sistema Hawaii UCN sin persistir en base de datos local.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 503,
    description: 'Servicio Hawaii UCN no disponible',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Sincroniza estudiantes NEE desde Hawaii UCN y los guarda/actualiza en la base de datos local del sistema INCLUI2.',
  })
  @ApiBody({
  ...
  @ApiResponse({
    ...
    example: {
      message:
        'Sincronización y persistencia de estudiantes NEE para semestre 2025-1 completada',
      count: 18,
    },
  })
  @ApiResponse({
    status: 400,
    description: 'Semestre es obligatorio o formato inválido',
  })
  @ApiResponse({ status: 401, description: 'Token de autenticación inválido' })
  ...
  @Post('courses')
  @ApiOperation({
    summary: 'Sincronizar cursos desde Hawaii UCN para un semestre',
  })
  @ApiResponse({
    status: 200,
    description: 'Cursos sincronizados correctamente',
  })
  ...
  @ApiOperation({
    summary:
      'Sincronizar y persistir cursos desde Hawaii UCN en la base de datos',
  })
  @ApiResponse({
    status: 200,
    description: 'Cursos sincronizados y persistidos correctamente',
  })
  ...
  @Post('inscriptions')
  @ApiOperation({
    summary: 'Sincronizar inscripciones desde Hawaii UCN para un semestre',
  })
  @ApiResponse({
    status: 200,
    description: 'Inscripciones sincronizadas correctamente',
  })
  ...
  @ApiOperation({
    summary:
      'Sincronizar inscripciones de estudiantes NEE desde Hawaii UCN para un semestre',
  })
  @ApiResponse({
    status: 200,
    description: 'Inscripciones de estudiantes NEE sincronizadas correctamente',
  })
