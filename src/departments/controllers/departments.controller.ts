...
export class DepartmentsController {
  ...
  @ApiOperation({
    ...
    description:
      'Registra un nuevo departamento en el sistema. Solo los coordinadores pueden crear departamentos. El código del departamento debe ser único.',
  })
  @ApiBody({
    ...
    examples: {
      ejemplo_departamento: {
        value: {
          ...
          description:
            'Departamento encargado de las carreras de computación e informática',
          isActive: true,
        },
      },
    },
  ...
  @ApiResponse({
    status: 400,
    description:
      'Datos de entrada inválidos - El código o nombre no cumplen los requisitos.',
  })
  @ApiResponse({
    status: 401,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna la lista completa de departamentos académicos. Todos los usuarios autenticados pueden ver esta información. Permite filtrar por semestre.',
  })
  @ApiQuery({
    name: 'semester',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Busca y retorna la información completa de un departamento utilizando su ID único. Incluye información del jefe de departamento si está asignado.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Actualiza parcialmente la información de un departamento. Solo se actualizan los campos enviados en el body. Solo coordinadores pueden actualizar departamentos.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 403,
    description:
      'Prohibido - Solo coordinadores pueden actualizar departamentos.',
  })
  async update(
    @Param('id') id: string,
  ...
  @ApiOperation({
    ...
    description:
      'Elimina permanentemente un departamento del sistema. Esta acción es irreversible. El departamento no debe tener carreras asociadas para poder ser eliminado.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 204,
    description:
      'Departamento eliminado exitosamente. Sin contenido en la respuesta.',
  })
  @ApiResponse({
    status: 404,
    description: 'Departamento no encontrado con el ID especificado.',
  ...
  @ApiResponse({
    status: 400,
    description:
      'No se puede eliminar - El departamento tiene carreras asociadas.',
  })
  @ApiResponse({
    status: 401,
    description: 'No autorizado - Token JWT inválido o expirado.',
  ...
  @ApiResponse({
    status: 403,
    description:
      'Prohibido - Solo coordinadores pueden eliminar departamentos.',
  })
