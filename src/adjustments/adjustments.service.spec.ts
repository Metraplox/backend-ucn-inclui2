...
describe('AdjustmentsService', () => {
  ...
  beforeEach(async () => {
    ...
    adjustmentWorkflowService = module.get<AdjustmentWorkflowService>(AdjustmentWorkflowService);
  });
  ...
  describe('updateStatus', () => {
    it('debería actualizar el estado y agregar una entrada al historial para una transición válida', async () => {
      ...
      jest.spyOn(adjustmentWorkflowService, 'updateStatus').mockResolvedValue(expectedResult as any);
    ...
    it('debería lanzar BadRequestException para una transición de estado inválida', async () => {
      jest.spyOn(adjustmentWorkflowService, 'updateStatus').mockRejectedValue(
    ...
    it('debería lanzar NotFoundException si el ajuste no se encuentra', async () => {
      jest.spyOn(adjustmentWorkflowService, 'updateStatus').mockRejectedValue(
        new NotFoundException('Ajuste no encontrado')
      );
