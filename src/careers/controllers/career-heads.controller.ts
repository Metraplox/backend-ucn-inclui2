...
export class CareerHeadsController {
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene la información completa de la carrera asignada al jefe de carrera autenticado, incluyendo estadísticas generales y datos de configuración.',
  })
  @ApiResponse({
    status: 200,
    ...
    schema: {
      example: {
        career: {
          ...
          description:
            'Carrera orientada a la formación de profesionales en computación e informática',
          department: {
  ...
  async getMyCareer(
    ...
    if (!careers || careers.length === 0) {
      throw new NotFoundException(
        'No se encontró ninguna carrera asociada a este jefe',
      );
    }

    // Convertir a objeto plano y asegurar el tipo
    const career =
      typeof (careers[0] as any).toObject === 'function'
        ? (careers[0] as any).toObject()
        : careers[0];
  ...
  @ApiOperation({
    ...
    description:
      'Proporciona estadísticas exhaustivas sobre la carrera del jefe autenticado, incluyendo distribución de estudiantes con NEE, estado de ajustes razonables, rendimiento por semestre académico y métricas de implementación.',
  })
  @ApiQuery({
    name: 'semester',
    required: false,
    description:
      'Semestre académico específico para generar estadísticas (formato YYYY-P). Si no se especifica, se usan los datos del semestre actual de la carrera.',
    example: '2025-1',
    schema: {
      type: 'string',
      pattern: '^\\d{4}-[1-2]$',
  ...
  @ApiResponse({
    ...
    description:
      'Parámetros de solicitud inválidos o formato de semestre incorrecto',
    schema: {
      examples: {
  ...
  @ApiResponse({
    ...
    description:
      'No se encontró información para los criterios de búsqueda especificados',
    schema: {
      example: {
        statusCode: 404,
  ...
  async getStatistics(
    ...
    if (!careers || careers.length === 0) {
      throw new BadRequestException(
        'No se encontró ninguna carrera asignada a este jefe',
      );
    }
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene un listado detallado y paginado de los estudiantes matriculados en la carrera que dirige el jefe autenticado, con información académica, estado de NEE y opciones de filtrado por semestre.',
  })
  @ApiQuery({
    name: 'semester',
    required: false,
    description:
      'Filtrar por semestre académico específico (formato YYYY-P). Si no se especifica, se muestran estudiantes del semestre actual.',
    example: '2025-1',
    schema: {
      type: 'string',
      pattern: '^\\d{4}-[1-2]$',
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              fullName: {
                type: 'string',
                example: 'Luis Alberto Martínez Torres',
              },
              email: {
                type: 'string',
                example: 'luis.martinez@alumnos.ucn.cl',
              },
              ...
              lastActivity: {
                type: 'string',
                format: 'date-time',
                example: '2025-06-19T16:30:00.000Z',
              },
            },
          },
        },
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene un listado completo y detallado de los ajustes razonables de los estudiantes de la carrera, con capacidades avanzadas de filtrado por estado, tipo, semestre y opciones de búsqueda. Incluye estadísticas agregadas y métricas de implementación.',
  })
  @ApiQuery({
    name: 'status',
    required: false,
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      'Lista detallada de ajustes razonables con estadísticas y métricas',
    schema: {
      type: 'object',
      properties: {
        data: {
          ...
          items: {
            ...
            properties: {
              adjustmentId: {
                type: 'string',
                example: '507f1f77bcf86cd799439045',
              },
              ...
              description: {
                type: 'string',
                example: '50% tiempo adicional en evaluaciones',
              },
              ...
              approvedDate: {
                type: 'string',
                format: 'date-time',
                example: '2025-02-18T10:15:00.000Z',
              },
      ...
      examples: {
        ...
        'estado-invalido': {
          ...
          value: {
            statusCode: 400,
            message:
              'Estado de ajuste no válido. Opciones: pendiente, aprobado, rechazado, implementado, vencido',
            error: 'Bad Request',
          },
        },
      },
