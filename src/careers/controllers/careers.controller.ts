...
export class CareersController {
  ...
  @ApiOperation({ 
    ...
    description: 'Registra una nueva carrera en el sistema. La carrera se asocia automáticamente al departamento especificado. Solo coordinadores pueden crear carreras.'
  })
  @ApiBody({
    ...
    examples: {
      ejemplo_carrera: {
        value: {
          ...
          description: 'Carrera orientada al desarrollo de software y sistemas computacionales',
          duration: 5,
          isActive: true
        }
      }
  ...
  @ApiResponse({
    ...
    description: 'Datos de entrada inválidos - El código, nombre o departamento no son válidos.',
  })
  @ApiResponse({
  ...
  @ApiOperation({ 
    ...
    description: 'Retorna la lista completa de carreras académicas del sistema. Incluye información sobre el número de estudiantes y el jefe de carrera si está asignado. Accesible para todos los usuarios autenticados.'
  })
  @ApiResponse({
  ...
  @ApiOperation({ 
    ...
    description: 'Busca y retorna la información completa de una carrera utilizando su ID único. Incluye información del departamento y jefe de carrera.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ 
    ...
    description: 'Actualiza parcialmente la información de una carrera. Solo se actualizan los campos enviados en el body. Solo coordinadores pueden actualizar carreras.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ 
    ...
    description: 'Elimina permanentemente una carrera del sistema. Esta acción es irreversible. La carrera no debe tener estudiantes activos para poder ser eliminada.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    ...
    description: 'Carrera eliminada exitosamente. Sin contenido en la respuesta.',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Carrera no encontrada con el ID especificado.',
  ...
  @ApiOperation({ 
    ...
    description: 'Lista todos los estudiantes con NEE que pertenecen a una carrera específica. Permite filtrar por semestre académico. Solo accesible para coordinadores, educadoras sociales y el jefe de la carrera correspondiente.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Prohibido - Usuario no tiene los permisos necesarios para ver estudiantes de esta carrera.',
  })
