...
export class DiddecController {
  ...
  @ApiOperation({ 
    ...
    description: 'Obtiene estadísticas comprensivas del sistema INCLUI2 para un semestre específico, incluyendo datos de estudiantes, ajustes, docentes y rendimiento general.'
  })
  @ApiQuery({ 
    name: 'semester', 
    required: true, 
  ...
  @ApiOperation({ 
    ...
    description: 'Genera un informe comprensivo y detallado de todas las actividades INCLUI2 durante un semestre específico, incluyendo análisis comparativo.'
  })
  @ApiParam({ 
    name: 'semester', 
    required: true, 
  ...
  @ApiResponse({ 
    ...
    example: {
      ...
      comparison: {
        previousSemester: {
          growth: '+12.5%',
          improvementAreas: ['Tiempo de implementación', 'Satisfacción estudiantil']
        }
      }
    }
  })
  @ApiResponse({ status: 404, description: 'Semestre no encontrado o sin datos' })
  ...
  @ApiOperation({ 
    ...
    description: 'Lista completa de estudiantes con Necesidades Educativas Especiales registrados en el sistema para un semestre específico, incluyendo su información académica y ajustes.'
  })
  @ApiQuery({ 
    name: 'semester', 
    required: true, 
  ...
  @ApiOperation({ 
    ...
    description: 'Analiza las tendencias de implementación y uso de ajustes razonables a lo largo de múltiples semestres, identificando patrones y evolución del sistema.'
  })
  @ApiQuery({ 
    name: 'years', 
    required: false, 
    ...
    example: {
      ...
      semesterData: [
        ...
        },
        {
          ...
          topAdjustments: ['Tiempo adicional', 'Evaluación oral', 'Material adaptado']
        }
      ],
  ...
  @ApiOperation({ 
    ...
    description: 'Analiza las tasas de cumplimiento e implementación de ajustes razonables por departamento académico, identificando fortalezas y áreas de mejora.'
  })
  @ApiQuery({ 
    name: 'semester', 
    required: true, 
      ...
      departmentAnalysis: [
        {
          ...
          challenges: ['Coordinación con laboratorios', 'Evaluaciones prácticas'],
          strengths: ['Respuesta rápida de docentes', 'Buena infraestructura tecnológica']
        },
        {
          department: 'Ciencias',
          metrics: {
