...
export class CategoriesController {
  ...
  @ApiOperation({ 
    ...
    description: 'Crea una nueva categoría de Necesidades Educativas Especiales (NEE) que puede ser utilizada para clasificar y organizar ajustes razonables. Solo coordinadores y educadoras sociales pueden crear categorías.',
  })
  @ApiBody({
    ...
    examples: {
      'tiempo-adicional': {
        ...
        value: {
          ...
          description: 'Otorga un 50% de tiempo extra en pruebas y exámenes para estudiantes que lo requieran',
          isActive: true
        }
      },
      'evaluacion-oral': {
        ...
        value: {
          ...
          description: 'Permite reemplazar evaluaciones escritas por evaluaciones orales para estudiantes con dificultades de escritura',
          isActive: true
        }
      },
      'material-adaptado': {
        ...
        value: {
          ...
          description: 'Proporciona materiales de estudio en formatos alternativos como audio, braille o letra grande',
          isActive: true
        }
      }
    }
  ...
  @ApiOperation({ 
    ...
    description: 'Obtiene la lista completa de categorías de Necesidades Educativas Especiales disponibles en el sistema. Incluye tanto categorías activas como inactivas para referencia completa.',
  })
  @ApiResponse({ 
    status: 200, 
    ...
    schema: {
      example: [
        ...
        },
        {
          ...
          description: 'Modificaciones del entorno físico para mejorar la accesibilidad (ubicación, iluminación, etc.)',
          isActive: false,
  ...
  @ApiOperation({ 
    ...
    description: 'Obtiene los detalles completos de una categoría de NEE específica por su ID, incluyendo toda la información asociada.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({ 
    ...
    schema: {
      example: {
        _id: '507f1f77bcf86cd799439028',
        name: 'Tiempo adicional para evaluaciones',
        description: 'Otorga un 50% de tiempo extra en pruebas y exámenes para estudiantes que lo requieran. Esta adaptación es especialmente útil para estudiantes con trastornos de atención, dislexia o ansiedad.',
        isActive: true,
        createdAt: '2025-06-19T18:00:00.000Z',
        updatedAt: '2025-06-19T18:00:00.000Z'
      }
  ...
  @ApiOperation({ 
    ...
    description: 'Actualiza los datos de una categoría de NEE existente. Permite modificar nombre, descripción y estado activo/inactivo. Solo coordinadores y educadoras sociales pueden realizar actualizaciones.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiBody({
    ...
    examples: {
      'actualizar-descripcion': {
        ...
        value: {
          description: 'Otorga un 50% de tiempo extra en pruebas y exámenes. Aplicable a estudiantes con TDAH, dislexia, ansiedad o cualquier condición que afecte la velocidad de procesamiento.'
        }
      },
      ...
      'actualizar-completo': {
        ...
        value: {
          ...
          description: 'Otorga tiempo extra tanto en evaluaciones como en entrega de trabajos según las necesidades específicas del estudiante',
          isActive: true
        }
      }
    }
  ...
  @ApiOperation({ 
    ...
    description: 'Elimina permanentemente una categoría de NEE del sistema. ADVERTENCIA: Esta acción es irreversible y puede afectar ajustes existentes que usen esta categoría. Se recomienda desactivar en lugar de eliminar.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({ 
    status: 204, 
    description: 'Categoría de NEE eliminada exitosamente (sin contenido en respuesta)',
  })
  @ApiResponse({ 
    status: 400, 
    ...
    schema: {
      examples: {
        ...
        'categoria-en-uso': {
          ...
          value: {
            statusCode: 400,
            message: 'Cannot delete category that has associated adjustments. Please deactivate instead.',
            error: 'Bad Request'
          }
        }
      }
