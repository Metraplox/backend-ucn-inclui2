  ...
  implements OnGatewayConnection, OnGatewayDisconnect
{
  ...
  async handleMarkNotificationRead(client: Socket, payload: { notificationId: string }) {
    try {
      const notification = await this.notificationsService.markAsRead(payload.notificationId);
      const userId = client.data.userId;
