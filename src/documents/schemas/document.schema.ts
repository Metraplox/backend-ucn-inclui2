...
export class DocumentEntity {
  @ApiProperty({
    description: 'ID único del documento (generado por MongoDB)',
    example: '605c72ef9167f86c2cabc001',
  })
  declare _id: string;

  @ApiProperty({
    description: 'ID del estudiante asociado al documento',
  ...
  @ApiProperty({
    description:
      'Nombre del archivo almacenado en el sistema (puede incluir UUID)',
    example: 'uuid-informe_medico.pdf',
  })
  @Prop({ required: true, trim: true })
  storageFileName: string;

  @ApiProperty({
    description: 'Ruta donde se almacena el archivo en el servidor',
    example: 'uploads/uuid-informe_medico.pdf',
  })
  @Prop({ required: true, trim: true })
  filePath: string;
  ...
  @ApiProperty({
    ...
    example: 'Informe detallado del especialista.',
    required: false,
  })
  @Prop({ trim: true })
  description?: string;
  ...
  @ApiProperty({
    description: 'ID del usuario (personal/admin) que subió el documento',
  ...
  @ApiProperty({
    ...
    example: '2023-05-10T09:00:00.000Z',
  })
  ...
  @ApiProperty({
    ...
    enum: DocumentStatus,
    example: DocumentStatus.PENDIENTE,
  })
  @Prop({
    type: String,
    enum: DocumentStatus,
  ...
  @ApiProperty({
    description: 'ID del usuario que verificó el documento',
    example: '605c72ef9167f86c2cabc789',
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Fecha de verificación del documento',
  ...
  @ApiProperty({
    description: 'Comentarios sobre la verificación',
  ...
  @ApiProperty({
    ...
    example: 'https://example.com/files/uuid-informe_medico.pdf',
    required: false,
  })
  @Prop({ trim: true })
  fileUrl?: string;
