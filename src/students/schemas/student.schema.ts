...
export class Student {
  @ApiProperty({ description: 'ID único del estudiante (generado por MongoDB)', example: '605c72ef9167f86c2cabc123' })
  declare _id: string; // Agregado para Swagger, Mongoose lo maneja internamente

  @ApiProperty({ description: 'RUT único del estudiante', example: '12345678-9' })
  ...
  @ApiProperty({ description: 'Fecha de nacimiento del estudiante (YYYY-MM-DD)', example: '2000-05-15', required: false, type: String, format: 'date' })
  @Prop({ type: Date, required: false })
  fechaNacimiento?: Date;

  @ApiProperty({ description: 'Información de contacto adicional', example: '+56912345678', required: false })
