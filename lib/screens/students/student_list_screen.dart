...
class _StudentListScreenState extends State<StudentListScreen> {
  ...
  Future<void> _loadInitialData() async {
    ...
    try {
      ...
      log.d("[StudentList] careers map: $_careerNamesMap");
      if (careers.isNotEmpty) {
        log.d(
          "[StudentList] first career: id=${careers.first.id}, name=${careers.first.name}",
        );
      }

      final studentsData = await StudentService.getAllStudents();
      log.d("[StudentList] students raw count: \\${studentsData.length}");
      if (!mounted) return;
      ...
      log.e(
        "[StudentList] error cargando datos iniciales: $e",
        error: e,
        stackTrace: s,
      );
      if (mounted) {
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            fillColor: Theme.of(context)
                                ...
                                .withValues(alpha: 0.5), // Color sutil
                            suffixIcon:
                            ...
                            : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final String careerNameDisplay =
                                    ...
                                    'Carrera no asignada';
                                // log.v("Mostrando estudiante: ${student.nombreCompleto}, Carrera: $careerNameDisplay");
