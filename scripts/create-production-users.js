...
const productionUsers = [
  {
    ...
    nombreCompleto: 'Coordinador Programa Incluye',
    roles: ['COORDINADOR'],
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    firstName: 'Educadora',
    lastName: 'Social',
    nombreCompleto: 'Educadora Social',
  ...
  },
  {
    ...
    firstName: 'Docente',
    lastName: 'Profesor',
    nombreCompleto: 'Docente Profesor',
    roles: ['DOCENTE'],
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  },
  {
    ...
    nombreCompleto: 'Jefe de Departamento',
